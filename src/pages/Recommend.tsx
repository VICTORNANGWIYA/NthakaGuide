...
export default function Recommend() {
  ...
  // Lab — SoilInputForm already collects landUse + previousCrop
  const handleLabSubmit = (data: SoilInput) => runAnalysis(data, "lab");

  // ✅ Field — now receives landUse + previousCrop from FieldAssessment
  ...
  // ✅ Combo — now receives landUse + previousCrop from ComboMode
